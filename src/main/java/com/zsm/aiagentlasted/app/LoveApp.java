...
import com.zsm.aiagentlasted.advisor.MyLoggerAdvisor;
import com.zsm.aiagentlasted.chatmemory.FileBasedChatMemory;
import com.zsm.aiagentlasted.rag.QueryRewriter;
...
//                .build();
        ...
        chatClient = ChatClient.builder(dashscopeChatModel)
                ...
                .defaultAdvisors(
                        ...
                        // 开启日志 advisor，记录 Ai 请求和响应的信息
                        new MyLoggerAdvisor()
                        // re2 重读顾问。测试为了节省Token，这里取消
//                        new ReReadingAdvisor()
    ...
    public String doChat(String message, String chatId) {
        ...
        log.info("ai相应的内容content：{}", content);
        return content;
    }
    ...
    public LoveReport doChatWithReport(String message, String chatId) {
        ...
        log.info("ai响应的内容content：{}", loveReport);
        return loveReport;
    }
...
//                .advisors(QuestionAnswerAdvisor.builder(vectorStore).build())
                // 应用自定义的 RAG 检索增强服务（文档查询器 + 上下文管理器）
